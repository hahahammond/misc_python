...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 11:51:34 2019
...
orchid_url = 'https://orcid.org/'+ orchid_id 
...
person = tree.xpath('//*[@id="main"]/div/div[1]/div/id-banner-ng2/div/h2/text()')[0].strip()
...
pmids = tree.xpath('//*[@id="body-work-list"]/li[1]/div/ul/li/div[2]/div/ul/li/ul/li[1]/span/ext-id-popover-ng2/a/text()')
